        ...
        >
          ...
          <div className='d-flex '>
            ...
            <div className="slide__caption">
              ...
              <p>&quot;Studies have shown that interaction with indoor plants may reduce psychological and physiological stress – in fact they can have a soothing effect.&quot;
              </p>
            </div>
          </div>
          <div className='d-flex text-white'>
            <img className='carousel-img' src="/images/carousel20.jpg" alt="20" />
            <div className="slide__caption">
              <h3>Add Some Green</h3>
              <p>&quot;Add a pop of natural green to liven up any room.&quot;
              </p>
            </div>
          </div>
          <div className='d-flex '>
            ...
            <div className="slide__caption">
              ...
              <p>&quot;Whether painting, reading, or gaming let the little ones quietly cheer you on.&quot;
              </p>
            </div>
          </div>
          <div>
